 ...
 */
	...
	private $mysqli = '';
	private $usuario = 'msanchez';
	private $clave = '7A3B7F5995542953A8025CEDF6D0B0971E1A9C3F';
	private $server = '10.10.99.15';
	private $db = 'CDRNTEST';
	...
	public function consultaArreglo($consulta) {
		...
		return mysqli_fetch_array($this->mysqli->query($consulta),MYSQLI_ASSOC);
